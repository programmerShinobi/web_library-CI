					...
					<div class="row">
						<div class="col-lg-12">
							<div class="p-5">
								...
								<button data-aos="fade-right" data-aos-duration="1000" type="submit" class="text-center btn btn-success btn-sm"><i class="fas fa-arrow-circle-right  fa-sm fa-fw mr-2 text-gray-400"></i>Kirim Ulang Kode Verifikasi</button>
								<?= form_close(); ?>
								<hr>
