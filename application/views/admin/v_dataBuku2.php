	...
	<div class="card">
		<div class="card-header">
			<ul class="nav nav-pills" role="tablist">
				...
				<li class="nav-item border border-primary rounded m-1">
					<a class="nav-link active" data-toggle="pill" href="#BukuNonaktif">X - Buku Nonaktif</a>
				</li>
			</ul>
		</div>
		<div class="card-body">
			<div class="tab-content">
				...
				<div id="BukuAktif" class="tab-pane container">
					<b><?= "Buku Aktif" ?></b>
					<hr>
					<div class="table-responsive">
				...
				<div id="BukuNonaktif" class="tab-pane container active">
					<b><?= "Buku Non Aktif" ?></b>
					<hr>
					<div class="table-responsive">
