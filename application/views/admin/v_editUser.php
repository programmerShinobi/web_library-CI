...
<div class="container-fluid">
	...
	<div class="card mb-4">
		<div class="card-body">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<select class="form-control" name="user_klasifikasi" required>
							<option name="user_klasifikasi" value="1" <?php if ($user_detail->user_klasifikasi == "1") {
																													echo 'selected';
																												} ?> /> TK</option>
							<option name="user_klasifikasi" value="2" <?php if ($user_detail->user_klasifikasi == "2") {
																													echo 'selected';
																												} ?> /> SD</option>
							<option name="user_klasifikasi" value="3" <?php if ($user_detail->user_klasifikasi == "3") {
																													echo 'selected';
																												} ?> /> SMP</option>
							<option name="user_klasifikasi" value="4" <?php if ($user_detail->user_klasifikasi == "4") {
																													echo 'selected';
																												} ?> /> SMA</option>
							<option name="user_klasifikasi" value="5" <?php if ($user_detail->user_klasifikasi == "5") {
																													echo 'selected';
																												} ?> /> Mahasiswa</option>
							<option name="user_klasifikasi" value="6" <?php if ($user_detail->user_klasifikasi == "6") {
																													echo 'selected';
																												} ?> /> PNS</option>
							<option name="user_klasifikasi" value="7" <?php if ($user_detail->user_klasifikasi == "7") {
																													echo 'selected';
																												} ?> /> Karyawan</option>
							<option name="user_klasifikasi" value="8" <?php if ($user_detail->user_klasifikasi == "8") {
																													echo 'selected';
																												} ?> /> Umum</option>
						</select>
					</div>
			...
			<a href="<?= base_url("dataAnggota") ?>" class="btn btn-info btn-sm mb"><i class="fas fa-chevron-left"></i> Kembali</a>
