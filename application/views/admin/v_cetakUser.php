...
<body onload='window.print()' style="font-family: arial;font-size: 12px;position:absolute;margin-top: -30px;margin-left: -30px;">
	<div style="background-size: cover;background-repeat: no-repeat; width: 400px;height: 200px;margin: 30px;background-image:url('<?= base_url('/vendor/img/Icon/bismillah_.png') ?>');">
		<img style="position: absolute;padding-left: 10px;padding-top: 10px;" class="" src="<?= base_url('/vendor/img/Icon/Karawang.png') ?>" width="0px">
		...
		<p style="padding-left: 145px;padding-top: 80px;font-size: 10px; "><b>KARTU <?php if ($user->user_role == 2) {
																																									echo "PETUGAS";
																																								} else {
																																									echo "ANGGOTA";
																																								}  ?></b></p>
		...
		<table style="margin-top: -5px;padding-left: 143px; position: relative;font-family: arial;font-size: 10px;">
			<tr>
				<td>Kode <?php if ($user->user_role == 2) {
										echo "Petugas";
									} else {
										echo "Anggota";
									}  ?></td>
			...
			<tr>
				<td>Berlaku</td>
				<td>: Selama Menjadi <?php if ($user->user_role == 2) {
																echo "Petugas";
															} else {
																echo "Anggota";
															}  ?></td>
